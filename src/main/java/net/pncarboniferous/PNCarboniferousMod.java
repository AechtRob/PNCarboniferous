...
@Mod(modid = PNCarboniferousMod.MODID, name = PNCarboniferousMod.NAME, version = PNCarboniferousMod.VERSION, dependencies = "required-after:lepidodendron@[52.0,)")
public class PNCarboniferousMod {
    ...
    @Mod.Instance(MODID)
    public static PNCarboniferousMod instance;
    public ElementsPNCarboniferousMod elements = new ElementsPNCarboniferousMod();
    ...
    public void preInit(FMLPreInitializationEvent event) {
        ...
        NetworkRegistry.INSTANCE.registerGuiHandler(this, new ElementsPNCarboniferousMod.GuiHandler());
