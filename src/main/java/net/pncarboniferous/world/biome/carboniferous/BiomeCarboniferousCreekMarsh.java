...
public class BiomeCarboniferousCreekMarsh extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:carboniferous_creek_marsh")
	public static final BiomeGenCustom biome = null;
	public BiomeCarboniferousCreekMarsh(ElementsLepidodendronMod instance) {
		super(instance, 1591);
	}
	...
	static class BiomeGenCustom extends BiomeCarboniferous {
		public BiomeGenCustom() {
			super(new BiomeProperties("Carboniferous Marshland Creek").setRainfall(0.5F).setBaseHeight(-0.525F).setHeightVariation(0.0F).setTemperature(0.95F).setRainfall(0.9F).setWaterColor(3906905));
			setRegistryName("lepidodendron:carboniferous_creek_marsh");
