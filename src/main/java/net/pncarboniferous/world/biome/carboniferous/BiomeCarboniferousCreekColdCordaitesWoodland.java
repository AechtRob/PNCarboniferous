...
public class BiomeCarboniferousCreekColdCordaitesWoodland extends ElementsPNCarboniferousMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:carboniferous_creek_cold_woodland")
	public static final BiomeGenCustom biome = null;
	public BiomeCarboniferousCreekColdCordaitesWoodland(ElementsPNCarboniferousMod instance) {
		super(instance, 1591);
	}
	...
	static class BiomeGenCustom extends BiomeCarboniferous {
		public BiomeGenCustom() {
			super(new BiomeProperties("Carboniferous Cool Cordaites Woodland Creek").setRainfall(0.9F).setBaseHeight(-0.525F).setHeightVariation(0.0F).setTemperature(0.25F));
			setRegistryName("lepidodendron:carboniferous_creek_cold_woodland");
	    ...
	    public void decorate(World worldIn, Random rand, BlockPos pos)
	    {
			...
			if(net.minecraftforge.event.terraingen.TerrainGen.decorate(worldIn, rand, new net.minecraft.util.math.ChunkPos(pos), DecorateBiomeEvent.Decorate.EventType.GRASS))
				for (int i = 0; i < 64; ++i)
				{
					...
					int k = rand.nextInt(16) + 8;
					int l = rand.nextInt(worldIn.getHeight(pos.add(j, 0, k)).getY() + 32);
					LEAF_LITTER.generate(worldIn, rand, pos.add(j, l, k));
				}
