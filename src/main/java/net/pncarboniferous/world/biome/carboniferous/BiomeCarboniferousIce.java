...
public class BiomeCarboniferousIce extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:carboniferous_polar_desert")
	public static final BiomeGenCustom biome = null;
	public BiomeCarboniferousIce(ElementsLepidodendronMod instance) {
		super(instance, 1591);
	}
	...
	static class BiomeGenCustom extends BiomeCarboniferous {
		public BiomeGenCustom() {
			super(new BiomeProperties("Carboniferous Polar Desert").setRainfall(0.1F).setBaseHeight(0.15F).setHeightVariation(0.16F).setTemperature(-2.0F).setSnowEnabled());
			setRegistryName("lepidodendron:carboniferous_polar_desert");
