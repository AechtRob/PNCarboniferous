...
public class BiomeCarboniferousCreekHills extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:carboniferous_creek_hills")
	public static final BiomeGenCustom biome = null;
	public BiomeCarboniferousCreekHills(ElementsLepidodendronMod instance) {
		super(instance, 1591);
	}
	...
	static class BiomeGenCustom extends BiomeCarboniferous {
		public BiomeGenCustom() {
			//super(new Biome.BiomeProperties("Carboniferous Hills").setRainfall(0.5F).setBaseBiome("lepidodendron:carboniferous_swamp_hills_edge").setBaseHeight(1.05F).setHeightVariation(0.5F).setTemperature(0.75F).setRainfall(0.9F).setWaterColor(8186044));
			super(new BiomeProperties("Carboniferous Hills Creek").setBaseHeight(-0.525F).setHeightVariation(0.0F).setTemperature(0.65F).setRainfall(0.9F).setWaterColor(3906905));
			setRegistryName("lepidodendron:carboniferous_creek_hills");
