...
public class BiomeCarboniferousColdCordaitesWoodland extends ElementsPNCarboniferousMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:carboniferous_cold_woodland")
	public static final BiomeGenCustom biome = null;
	public BiomeCarboniferousColdCordaitesWoodland(ElementsPNCarboniferousMod instance) {
		super(instance, 1591);
	}
