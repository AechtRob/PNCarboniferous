...
public class BiomeCarboniferousCreekCoastal extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:carboniferous_creek_coastal")
	public static final BiomeGenCustom biome = null;
	public BiomeCarboniferousCreekCoastal(ElementsLepidodendronMod instance) {
		super(instance, 1591);
	}
	...
	static class BiomeGenCustom extends BiomeCarboniferous {
		public BiomeGenCustom() {
			super(new BiomeProperties("Carboniferous Coastal Creek").setRainfall(0.5F).setBaseHeight(-0.525F).setHeightVariation(0.0F).setWaterColor(13038245));
			setRegistryName("lepidodendron:carboniferous_creek_coastal");
