...
public class BiomeCarboniferousEstuary extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:carboniferous_estuary")
	public static final BiomeGenCustom biome = null;
	public BiomeCarboniferousEstuary(ElementsLepidodendronMod instance) {
		super(instance, 1591);
	}
	...
	static class BiomeGenCustom extends BiomeCarboniferous {
		public BiomeGenCustom() {
			super(new BiomeProperties("Carboniferous Estuary").setRainfall(0.5F).setBaseHeight(-0.275F).setHeightVariation(0.00F).setWaterColor(3906905));
			setRegistryName("lepidodendron:carboniferous_estuary");
		...
		protected static final WorldGenMacroneuropterisTree MACRONEUROPTERIS = new WorldGenMacroneuropterisTree(false);
		protected static final WorldGenMacroneuropterisNoWater MACRONEUROPTERIS_DRY = new WorldGenMacroneuropterisNoWater(false);
		...
		public WorldGenAbstractTree getRandomTreeFeature(Random rand)
	    {
	    	if (rand.nextInt(12) == 0) {
				return MACRONEUROPTERIS;
			}
			if (rand.nextInt(12) == 0) {
				return MACRONEUROPTERIS_DRY;
			}
			return CORDAITES;
	    }
	    ...
	    public void decorate(World worldIn, Random rand, BlockPos pos)
	    {
			...
			if(net.minecraftforge.event.terraingen.TerrainGen.decorate(worldIn, rand, new net.minecraft.util.math.ChunkPos(pos), DecorateBiomeEvent.Decorate.EventType.GRASS))
				for (int ii = 0; ii < 2; ++ii)
				{
					...
					STATIC_GENERATOR.generate(BlockEscumasia.block.getDefaultState(), worldIn, rand, pos.add(j, l, k), 1, 15, 0, 255);
				}
			...
			if(net.minecraftforge.event.terraingen.TerrainGen.decorate(worldIn, rand, new net.minecraft.util.math.ChunkPos(pos), DecorateBiomeEvent.Decorate.EventType.GRASS))
				for (int ii = 0; ii < 2; ++ii)
				{
					...
					int k = rand.nextInt(16) + 8;
					int l = ChunkGenSpawner.getTopSolidBlock(pos.add(j, 0, k), worldIn).getY() + 1;
					STATIC_SIDEWAYS_GENERATOR.generate(BlockEscumasia.block.getDefaultState(), worldIn, rand, pos.add(j, l, k), 1, 15, 0, 255);
				}
			...
			if(net.minecraftforge.event.terraingen.TerrainGen.decorate(worldIn, rand, new net.minecraft.util.math.ChunkPos(pos), DecorateBiomeEvent.Decorate.EventType.GRASS))
				for (int ii = 0; ii < 4; ++ii)
				{
					...
					int k = rand.nextInt(16) + 8;
					int l = rand.nextInt(worldIn.getSeaLevel() + 25);
					STATIC_GENERATOR.generate(BlockGreenCharaAlgae.block.getDefaultState(), worldIn, rand, pos.add(j, l, k), 1, 30, 0, 255);
				}
