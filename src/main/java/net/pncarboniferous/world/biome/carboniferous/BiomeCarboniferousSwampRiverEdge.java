...
public class BiomeCarboniferousSwampRiverEdge extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:carboniferous_swamp_river_border")
	public static final BiomeGenCustom biome = null;
	public BiomeCarboniferousSwampRiverEdge(ElementsLepidodendronMod instance) {
		super(instance, 1591);
	}
