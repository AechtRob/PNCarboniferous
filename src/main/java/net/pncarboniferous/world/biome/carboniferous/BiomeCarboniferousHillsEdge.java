...
public class BiomeCarboniferousHillsEdge extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:carboniferous_hills_edge")
	public static final BiomeGenCustom biome = null;
	public BiomeCarboniferousHillsEdge(ElementsLepidodendronMod instance) {
		super(instance, 1591);
	}
	...
	static class BiomeGenCustom extends BiomeCarboniferous {
		public BiomeGenCustom() {
			...
			super(new BiomeProperties("Carboniferous Hills").setBaseHeight(1.0F).setHeightVariation(0.125F).setTemperature(0.65F).setRainfall(0.9F).setWaterColor(3906905));
			setRegistryName("lepidodendron:carboniferous_hills_edge");
