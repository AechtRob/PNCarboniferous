...
public class BiomeCarboniferousIceLakes extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:carboniferous_polar_lakes")
	public static final BiomeGenCustom biome = null;
	public BiomeCarboniferousIceLakes(ElementsLepidodendronMod instance) {
		super(instance, 1591);
	}
	...
	static class BiomeGenCustom extends BiomeCarboniferous {
		public BiomeGenCustom() {
			super(new BiomeProperties("Carboniferous Polar Lakes").setRainfall(0.1F).setBaseHeight(-0.15F).setHeightVariation(0.46F).setTemperature(-2.0F).setSnowEnabled());
			setRegistryName("lepidodendron:carboniferous_polar_lakes");
