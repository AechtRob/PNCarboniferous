...
public class BiomeCarboniferousCreekSwamp extends ElementsLepidodendronMod.ModElement {
	...
	static class BiomeGenCustom extends BiomeCarboniferous {
		public BiomeGenCustom() {
			...
			super(new BiomeProperties("Carboniferous Swamp Creek").setRainfall(0.5F).setBaseHeight(-0.525F).setHeightVariation(0.0F).setTemperature(0.95F).setRainfall(0.9F).setWaterColor(3906905));
