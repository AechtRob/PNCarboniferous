...
public class BiomeCarboniferousSwampHills extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:carboniferous_swamp_hills")
	public static final BiomeGenCustom biome = null;
	public BiomeCarboniferousSwampHills(ElementsLepidodendronMod instance) {
		super(instance, 1591);
	}
