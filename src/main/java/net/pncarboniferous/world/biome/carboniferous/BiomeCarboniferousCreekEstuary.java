...
public class BiomeCarboniferousCreekEstuary extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:carboniferous_creek_estuary")
	public static final BiomeGenCustom biome = null;
	public BiomeCarboniferousCreekEstuary(ElementsLepidodendronMod instance) {
		super(instance, 1591);
	}
	...
	static class BiomeGenCustom extends BiomeCarboniferous {
		public BiomeGenCustom() {
			super(new BiomeProperties("Carboniferous Estuary Creek").setRainfall(0.5F).setBaseHeight(-0.525F).setHeightVariation(0.0F).setWaterColor(3906905));
			setRegistryName("lepidodendron:carboniferous_creek_estuary");
