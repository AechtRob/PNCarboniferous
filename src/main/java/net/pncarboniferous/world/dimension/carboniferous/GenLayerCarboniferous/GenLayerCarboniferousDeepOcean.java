...
public class GenLayerCarboniferousDeepOcean extends GenLayer
{
    ...
    public GenLayerCarboniferousDeepOcean(long seed, GenLayer genLayer)
    {
        super(seed);
    ...
    private int[] getIntsOcean(int p_151626_1_, int p_151626_2_, int p_151626_3_, int p_151626_4_)
    {
        ...
        for (int i1 = 0; i1 < p_151626_4_; ++i1)
        {
            for (int j1 = 0; j1 < p_151626_3_; ++j1)
            {
                ...
                if (k1 == CARBONIFEROUS_OCEAN_SHORE_ID)
                {
                    ...
                    boolean flag = (
                        (l1 == CARBONIFEROUS_OCEAN_ID || l1 == CARBONIFEROUS_OCEAN_SHORE_ID)
                        && (i2 == CARBONIFEROUS_OCEAN_ID || i2 == CARBONIFEROUS_OCEAN_SHORE_ID)
                        && (j2 == CARBONIFEROUS_OCEAN_ID || j2 == CARBONIFEROUS_OCEAN_SHORE_ID)
                        && (k2 == CARBONIFEROUS_OCEAN_ID || k2 == CARBONIFEROUS_OCEAN_SHORE_ID)
                    );
                    if (flag)
                    {
                        k1 = CARBONIFEROUS_OCEAN_ID;
                    }
                }
